/**
 * Durable, keyless catalog contracts shared by the server and the Library UI.
 *
...
export type CatalogChronologyPlacement =
  | {
...
/**
 * Derive the canonical chronology placement for a catalog date.
 *
 ...
 */
export function deriveCatalogChronologyPlacement(
  value: unknown,
  ordinalValue: unknown
): CatalogChronologyPlacement | null {
