...
<div
	class="sheet open"
	data-testid="unified-song-panel"
	role="presentation"
	onclick={(event) => event.target === event.currentTarget && onClose()}
>
	<div class="panel song-panel" role="dialog" aria-modal="true" aria-label="Song">
		<button type="button" class="x" aria-label="Close search" onclick={onClose}>×</button>
		...
		<div class="pright">
			<button
				type="button"
				class="song-back"
				data-testid="unified-song-back"
				onclick={onBack}
			>
				← Search results
			</button>
			<div class="pt" data-testid="unified-song-title">{song.title}</div>
